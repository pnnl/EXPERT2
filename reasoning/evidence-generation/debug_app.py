...
class LoadWidget:
    def __init__(self, query_type, language_data_filepath, source_doc_filepath = None, graph_data_filepath = None, graph_text_link_filepath = None):
        try:            
            # Build Widget
            app = Dash(__name__,external_stylesheets=[dbc.themes.BOOTSTRAP,'https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.css'])
...
# filepaths
language_data_filepath = './demo/inputs/language-model-output_v2.jsonl'
source_doc_filepath = './demo/inputs/source-documents_v2.jsonl'          

# load widget - graph query
# LoadWidget('graph', language_data_filepath)

# load widget - Text query
LoadWidget('text', language_data_filepath, source_doc_filepath)