...
Created By: Sai Munikoti over the Entropy script by Shivam Sharma
Date: 10th Aug, 2023

This scripts contains classes and functions used for different UQ calculation steps 
in the Uncertainty Quantification Pipeline for Retrieval augmented LLM
...
class UQ_Entropy:
    ...
    def __init__(self, gen_probs):
        ...
        self.gen_probs = gen_probs # list of list of probabilities
