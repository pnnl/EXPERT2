...
MODEL_TO_EVAL="/atlas-mlm-gen-Atlantic-220M-fos-instun/checkpoint/step-10500/"
MODEL_FOR_INDEX="/models/atlas/base/"

port=$(shuf -i 15000-16000 -n 1)

EVAL_FILES="/fos/instructions_sample.jsonl"


SAVE_DIR=${DATA_DIR}/experiments
EXPERIMENT_NAME=atlas-mlm-gen-Atlantic-220M-fos-instun-foseval-step10k
